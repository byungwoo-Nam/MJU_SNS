package com.example.mju_sns.util.gps;
...
import com.example.mju_sns.util.fcm.QuickstartPreferences;
...
public class Location extends AppCompatActivity {
    ...
    public void setLocation() {
        GpsPermissionCheckForMashMallo(); // android 6.0 이상에서 호출해주어야 합니다. 권한때문
            ...
            if (isGPSEnabled || isNetworkEnabled) {
                ...
                locationListener = new LocationListener() {
                    ...
                    public void onLocationChanged(android.location.Location location) {
                        ...
                        System.out.println("location"+location.getProvider() + "," + location.getLatitude() + "," +location.getLongitude());
